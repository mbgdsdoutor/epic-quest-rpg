...
/* harmony import */ var _auth_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./auth.routing.module */ "./src/app/authentication/auth.routing.module.ts");
/* harmony import */ var _auth_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./auth.component */ "./src/app/authentication/auth.component.ts");
...
/* harmony import */ var _auth_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./auth.service */ "./src/app/authentication/auth.service.ts");
...
/* harmony import */ var _services_user_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./services/user.service */ "./src/app/authentication/services/user.service.ts");
...
AuthModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function AuthModule_Factory(t) { return new (t || AuthModule)(); }, providers: [
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AuthModule, { declarations: [_auth_component__WEBPACK_IMPORTED_MODULE_4__["AuthComponent"],
        _login_login_component__WEBPACK_IMPORTED_MODULE_5__["LoginComponent"],
        _register_register_component__WEBPACK_IMPORTED_MODULE_8__["RegisterComponent"],
        _forgot_password_forgot_password_component__WEBPACK_IMPORTED_MODULE_6__["ForgotPasswordComponent"]], imports: [_auth_routing_module__WEBPACK_IMPORTED_MODULE_3__["AuthRoutingModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"],
        _angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"]] }); })();
...
/* harmony import */ var _auth_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./auth.component */ "./src/app/authentication/auth.component.ts");
...
/* harmony import */ var _forgot_password_forgot_password_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./forgot-password/forgot-password.component */ "./src/app/authentication/forgot-password/forgot-password.component.ts");
/* harmony import */ var _register_register_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./register/register.component */ "./src/app/authentication/register/register.component.ts");
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵsetNgModuleScope"](AuthRoutingModule, { imports: [_angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClientModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"],
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AuthService, [{
    ...
    }], function () { return [{ type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"] }, { type: _token_storage_service__WEBPACK_IMPORTED_MODULE_2__["TokenStorageService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }]; }, null); })();
...
class ForgotPasswordComponent {
    constructor(formBuilder, tokenStorageService, router, authService) {
    ...
    configurarForm() {
        const email = this.formBuilder.control(null, [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required]);
...
ForgotPasswordComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ForgotPasswordComponent, selectors: [["app-forgot-password"]], decls: 14, vars: 3, consts: [[1, "auth-form-container", 3, "formGroup"], ["alt", "epic-quest-logo", "src", "assets/images/epicquest.png"], [1, "auth-form"], [1, "field"], ["for", "username"], ["placeholder", "digite seu email cadastrado", "id", "email", "formControlName", "email", 1, "input"], [1, "auth-form-actions"], [1, "button--link", 3, "routerLink"], [1, "button--primary"]], template: function ForgotPasswordComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "form", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](1, "img", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "div", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](3, "p");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](4, "Enviaremos um link para redefini\u00E7\u00E3o da sua senha para o e-mail fornecido.");
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ForgotPasswordComponent, [{
    ...
    }], function () { return [{ type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"] }, { type: src_app_token_storage_service__WEBPACK_IMPORTED_MODULE_2__["TokenStorageService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }, { type: _auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"] }]; }, null); })();
...
function LoginComponent_div_8_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](2, "campo obrigat\u00F3rio.");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
...
const _c1 = function () { return ["/auth/password/"]; };
const _c2 = function () { return ["/auth/register/"]; };
class LoginComponent {
    constructor(formBuilder, tokenStorageService, router, loadingService, alertService, authService) {
        this.formBuilder = formBuilder;
        this.tokenStorageService = tokenStorageService;
        this.router = router;
    ...
    configurarForm() {
        const username = this.formBuilder.control(null, [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required]);
        const password = this.formBuilder.control(null, [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required]);
        this.form = this.formBuilder.group({
            username,
            password
        });
...
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["app-login"]], decls: 21, vars: 13, consts: [[1, "auth-form-container", 3, "formGroup"], ["alt", "epic-quest-logo", "src", "assets/images/epicquest.png"], [1, "auth-form"], [1, "field", 3, "ngClass"], ["for", "username"], ["placeholder", "seu e-mail ou nome de usu\u00E1rio", "id", "username", "formControlName", "username", 1, "input"], ["username", ""], [4, "ngIf"], ["for", "password"], ["placeholder", "sua senha", "type", "password", "id", "password", "formControlName", "password", 1, "input"], [1, "button--primary", "full", 3, "click"], [1, "auth-form-actions"], [1, "button--link", 3, "routerLink"], [1, "button--primary", 3, "routerLink"]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "form", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](1, "img", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "div", 2);
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](LoginComponent, [{
    ...
    }], function () { return [{ type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"] }, { type: src_app_token_storage_service__WEBPACK_IMPORTED_MODULE_2__["TokenStorageService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }, { type: src_app_shared_loading_loading_service__WEBPACK_IMPORTED_MODULE_4__["LoadingService"] }, { type: src_app_shared_alert_service__WEBPACK_IMPORTED_MODULE_5__["AlertService"] }, { type: _auth_service__WEBPACK_IMPORTED_MODULE_6__["AuthService"] }]; }, null); })();
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
/* harmony import */ var src_app_utils_validators__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/utils/validators */ "./src/app/utils/validators.ts");
...
function RegisterComponent_div_15_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "small");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](2, "email inv\u00E1lido.");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
...
class RegisterComponent {
    constructor(formBuilder, loadingService, messageService, tokenStorageService, router, authService) {
        this.formBuilder = formBuilder;
        this.loadingService = loadingService;
    ...
    configurarForm() {
        const fullName = this.formBuilder.control(null, [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required]);
        const email = this.formBuilder.control(null, [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required, src_app_utils_validators__WEBPACK_IMPORTED_MODULE_2__["EpicValidators"].EMAIL]);
        const userName = this.formBuilder.control(null, [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required]);
        const description = this.formBuilder.control(null, [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required]);
        const password = this.formBuilder.control(null, [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required]);
        const confirmPassword = this.formBuilder.control(null, [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required, this.matchValues('password')]);
...
RegisterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: RegisterComponent, selectors: [["app-register"]], decls: 46, vars: 33, consts: [[1, "auth-form-container", 3, "formGroup"], [1, "register-form-header"], [1, "auth-form"], [1, "field", 3, "ngClass"], ["for", "fullName"], ["placeholder", "seu nome completo", "id", "fullName", "formControlName", "fullName", 1, "input"], [4, "ngIf"], ["for", "email"], ["placeholder", "seu email", "id", "email", "formControlName", "email", 1, "input"], ["for", "userName"], ["placeholder", "seu nome de usu\u00E1rio (nick)", "id", "userName", "formControlName", "userName", 1, "input"], ["for", "description"], ["placeholder", "fale um pouco sobre voc\u00EA", "id", "description", "formControlName", "description", 1, "input"], ["for", "photoUrl"], ["placeholder", "url da foto", "id", "photoUrl", "formControlName", "photoUrl", 1, "input"], ["for", "password"], ["placeholder", "digite sua senha", "type", "password", "id", "password", "formControlName", "password", 1, "input"], ["for", "confirmPassword"], ["placeholder", "confirme sua senha", "type", "password", "id", "confirmPassword", "formControlName", "confirmPassword", 1, "input"], [1, "auth-form-actions"], [1, "button--link", 3, "routerLink"], [1, "button--primary", 3, "disabled", "click"]], template: function RegisterComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "form", 0);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](18, "Nome de Usu\u00E1rio");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](43, "J\u00E1 \u00E9 cadastrado?");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](44, "button", 21);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function RegisterComponent_Template_button_click_44_listener() { return ctx.salvarUsuario(); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](RegisterComponent, [{
    ...
    }], function () { return [{ type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"] }, { type: src_app_shared_loading_loading_service__WEBPACK_IMPORTED_MODULE_3__["LoadingService"] }, { type: src_app_shared_alert_service__WEBPACK_IMPORTED_MODULE_4__["AlertService"] }, { type: src_app_token_storage_service__WEBPACK_IMPORTED_MODULE_5__["TokenStorageService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"] }, { type: _auth_service__WEBPACK_IMPORTED_MODULE_7__["AuthService"] }]; }, null); })();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EpicValidators", function() { return EpicValidators; });
class EpicValidators {
    static get EMAIL() {
        return (control) => {
